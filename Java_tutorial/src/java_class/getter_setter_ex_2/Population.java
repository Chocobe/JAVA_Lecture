...
public class Population {
	...
	public Population(String _city_name, int _population) {
		this(_city_name, _population, 10);
	}
	...
	// @param	:	N/A
	// @return	:	N/A
	private void calc_after_population() {
		this.after_population =
				(int)(this.cur_population + ((double)this.growth_rate / 100) * this.cur_population);
	}
